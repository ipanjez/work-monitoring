    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', position: 'relative' }}>
      ...
      <div id="calendar-container" className="glass" style={{ padding: '24px 28px', minHeight: '820px', display: 'flex', flexDirection: 'column' }}>
        <BigCalendar
          ...
          onSelectEvent={(event) => hasPermission(roleConfig, 'view_detail', userRole) ? openDetail(event.resource) : toast.error('Akses ditolak: Anda tidak memiliki izin untuk melihat detail.')}
          startAccessor="start"
          endAccessor="end"
          view={view}
          onView={setView}
